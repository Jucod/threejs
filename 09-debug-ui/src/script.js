...
const material = new THREE.MeshBasicMaterial({ color: debbugObject.color, wireframe: true })
...
cubeFolder
    .addColor(mesh.material, 'color')?.onChange(() =>
    {
        debbugObject.color = mesh.material.color.getHex();
    })
    .name('Color');
